...
if(message.author.id !== "317221808405348364" || message.author.id !== "169146903462805504" || message.author.id !== "306119836503900161") return message.channel.send(`:x: | ${message.author} tu n'est pas dans le support du bot.`) 
